...
final class HonkaiImpact3rdBridge extends BridgeAbstract
{
    ...
    public const API_URL = 'https://sg-public-api-static.hoyoverse.com/content_v2_user/app/5fcd2aa439ca4aea/getContentList?iPageSize=%u&iPage=1&sLangKey=%s&iChanId=513&isPreview=0';

    public const ARTICLE_URL = '/global/en-us/news/%u';
    ...
    public function collectData(): void
    {
        ...
        foreach ($list as $json_item) {
            ...
            if ($sExt !== '') {
                ...
                if (is_array($json_ext) === true) {
                    if (isset($json_ext['news-banner'][0]['url']) === true) {
                        $bannerUrl = (string) $json_ext['news-banner'][0]['url'];
                    } elseif (isset($json_ext['news-poster'][0]['url']) === true) {
